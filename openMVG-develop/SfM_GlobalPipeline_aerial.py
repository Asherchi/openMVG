...
OPENMVG_SFM_BIN = "/home/asher/Desktop/lib/openMVG/openMVG_Build/Linux-x86_64-RELEASE"

# Indicate the openMVG camera sensor width directory
CAMERA_SENSOR_WIDTH_DIRECTORY = "/home/asher/Desktop/lib/openMVG/src/software/SfM" + "/../../openMVG/exif/sensor_width_database"
...
input_dir = "/media/asher/软件/qianjian231128/mapper_qianjsjc231128_003026/subImages"
...
pIntrisics = subprocess.Popen( [os.path.join(OPENMVG_SFM_BIN, "openMVG_main_SfMInit_ImageListing"), "-P", "-i", input_dir, "-o", matches_dir, "-d", camera_file_params, "-f", "1360.514"] )
pIntrisics.wait()
...
pRecons = subprocess.Popen( [os.path.join(OPENMVG_SFM_BIN, "openMVG_main_SfM"), "-P", "--sfm_engine", "GLOBAL", "--input_file", matches_dir+"/sfm_data.json", "--match_file", matches_dir+"/matches.e.bin", "--output_dir", reconstruction_dir] )
pRecons.wait()
